...
struct FEnemyWaveSpawnerInfo
{
	...
	TSoftClassPtr<ANPCBase> SoftEnemyClassToSpawn;
	UPROPERTY(EditAnywhere)
 ...
 */
UCLASS()
class OMEGAPROJECT_API ASurvivalGameMode : public AOGameModeBase
{
	GENERATED_BODY()
...
public:
	...
	void RegisterSpawnedEnemies(const TArray<ANPCBase*>& InEnemiesToRegister);
...
private:
	...
	UPROPERTY()
	TMap<TSoftClassPtr<ANPCBase>,UClass* > PreLoadedEnemyClassMap;
