...
#include "OAttributeSet.generated.h"
 ...
 */
UCLASS()
class OMEGAPROJECT_API UOAttributeSet : public UAttributeSet
{
	GENERATED_BODY()
...
public:
	...
	ATTRIBUTE_ACCESSORS(UOAttributeSet, DarkResistance);
	...
	ATTRIBUTE_ACCESSORS(UOAttributeSet, ElectricResistance);

	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_FireResistance, Category = "Resistance Attributes")
	FGameplayAttributeData FireResistance;
	ATTRIBUTE_ACCESSORS(UOAttributeSet, FireResistance);

	UPROPERTY(BlueprintReadOnly, ReplicatedUsing = OnRep_IceResistance, Category = "Resistance Attributes")
	FGameplayAttributeData IceResistance;
	ATTRIBUTE_ACCESSORS(UOAttributeSet, IceResistance);
