...
class OMEGAPROJECT_API UAbilityMenuController : public UOWidgetController
{
	GENERATED_BODY()
public:
...
private:
	...
	FSelectedAbility SelectedAbility = { FOGameplayTags::Get().ability_none, FOGameplayTags::Get().ability_status_locked};
