...
#include "OInteractingComponent.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnBeginInteract, class APawn*, Interactor, class UOInteractComponent*, InteractComp);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnEndInteract, class APawn*, Interactor, class UOInteractComponent*, InteractComp);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnBeginFocus, class APawn*, Interactor, class UOInteractComponent*, InteractComp);
...
protected:
	...
	friend class UOInteractComponent;

public:	
	
	UOInteractingComponent();
...
protected:
	...
	virtual void BeginFocus(class APawn* Interactor, class UOInteractComponent* InteractComp);
	virtual void EndFocus(class APawn* Interactor, class UOInteractComponent* InteractComp);

	//Called on the client when the player begins/ends/interacts with the item
	virtual void BeginInteract(class APawn* Interactor, class UOInteractComponent* InteractComp);
	virtual void EndInteract(class APawn* Interactor, class UOInteractComponent* InteractComp);
	virtual bool Interact(class APawn* Interactor, class UOInteractComponent* InteractComp);

	UFUNCTION(BlueprintNativeEvent, Category = "Item")
	void OnInteract(class APawn* Interactor, class UOInteractComponent* InteractComp);
	virtual void OnInteract_Implementation(class APawn* Interactor, class UOInteractComponent* InteractComp);

	UFUNCTION(BlueprintNativeEvent, Category = "Item")
	void OnBeginInteract(class APawn* Interactor, class UOInteractComponent* InteractionComp);
	virtual void OnBeginInteract_Implementation(class APawn* Interactor, class UOInteractComponent* InteractComp);

	UFUNCTION(BlueprintNativeEvent, Category = "Item")
	void OnEndInteract(class APawn* Interactor, class UOInteractComponent* InteractionComp);
	virtual void OnEndInteract_Implementation(class APawn* Interactor, class UOInteractComponent* InteractComp);
	...
	*/
	...
	bool CanInteract(class APawn* Interactor, class UOInteractComponent* InteractComp, FText& OutErrorText);
	virtual bool CanInteract_Implementation(class APawn* Interactor, class UOInteractComponent* InteractComp, FText& OutErrorText);
