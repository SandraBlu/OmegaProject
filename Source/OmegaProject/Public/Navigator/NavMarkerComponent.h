...
UCLASS( ClassGroup=(Omega), Blueprintable, DisplayName = "Navigation Marker", meta=(BlueprintSpawnableComponent) )
class OMEGAPROJECT_API UNavMarkerComponent : public UActorComponent
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, DisplayName = "Add Marker To", Category = "Marker Setup", meta = (Bitmask, BitmaskEnum = "/Script/OmegaProject.ENavigatorType"))
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Marker")
	bool ShouldShowOn(UPARAM(meta = (Bitmask, BitmaskEnum = "/Script/OmegaProject.ENavigatorType")) int32 Categories);

	// Check if this marker should be shown in the given location 
	UFUNCTION(BlueprintCallable, Category = "Marker")
	void SetVisibility(UPARAM(meta = (Bitmask, BitmaskEnum = "/Script/OmegaProject.ENavigatorType")) int32 Categories);
