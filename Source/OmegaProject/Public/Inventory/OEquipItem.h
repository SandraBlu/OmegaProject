...
#include "OEquipItem.generated.h"
 ...
 */
UCLASS()
class OMEGAPROJECT_API UOEquipItem : public UOItem
{
	GENERATED_BODY()

	public:

	friend class UOEquipmentComponent;
 ...
 */
UCLASS()
class OMEGAPROJECT_API UOEquipItem_Clothing : public UOEquipItem
{
	GENERATED_BODY()

public:

	UOEquipItem_Clothing();
 ...
 */
UCLASS()
class OMEGAPROJECT_API UOEquipItem_Weapon : public UOEquipItem
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AOWeapon> WeaponClass;
};
